    ...
    <StyledHome>
        ...
        <div className="weddingDetails">
            <div className="weddingDetailText">
                ...
                <p>The ceremony and reception will both take place at Northlake Church in Lago Vista. Both will take place indoors, so don't sweat the hot weather!</p>
                <div className="whereWhen">
                    <p><b>Where:</b> 3610 Lohman Ford Rd, Lago Vista, TX 78645</p>
                    <p><b>When:</b> August 7th at 4pm</p>
                </div>
                <p>Please RSVP <a href="/rsvp" >here</a> by July 7th</p>
                <p>Taco Bell and wedding cake will be served! View and select your meal options through the RSVP menu.</p>
            </div>
        ...
        <div className="aboutUsContainer">
            ...
            <div className="aboutUsText">
                ...
                <div>
                    ...
                    <p>It was clear to both of them from the very beginning that theirs would be a friendship for the ages. The joy and belonging felt between the two was immediate, and the laughter hasn’t stopped for a moment since that first meeting. Jon and Morgan have bonded over their mutual love of food, entertainment, and adventure, and they inspire and encourage one another by their shared commitment to faith and godly values.</p>
